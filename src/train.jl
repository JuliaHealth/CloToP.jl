...
p1 = Plots.plot(clo_level[sorting_idx].^2 .- clo_level_pred[sorting_idx].^2, ylims=(-400, 400), xlabel="patients", ylabel="error", title="clozapine")
...
p2 = Plots.plot(nclo_level[sorting_idx].^2 .- nclo_level_pred[sorting_idx].^2, ylims=(-400, 400), xlabel="patients", ylabel="error", title="norclozapine")
